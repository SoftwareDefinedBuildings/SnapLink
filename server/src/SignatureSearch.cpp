...
bool SignatureSearch::init(const rtabmap::ParametersMap &parameters)
{
...
void SignatureSearch::setVisibility(Visibility *vis)
{
    _vis = vis;
}

void SignatureSearch::setHTTPServer(HTTPServer *httpServer)
{
...
bool SignatureSearch::localize(std::vector<int> wordIds, const rtabmap::SensorData *sensorData, rtabmap::Transform *pose, int *dbId, void *context)
{
...
rtabmap::Transform SignatureSearch::computeGlobalVisualTransform(std::vector<int> wordIds, const rtabmap::SensorData *sensorData, const rtabmap::CameraModel &cameraModel, int oldSigId) const
{
