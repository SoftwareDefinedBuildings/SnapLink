...
private:
    ...
    static std::list< std::unique_ptr<Word> > readWords(const std::string &dbPath, int dbId, const std::list< std::unique_ptr<Signature> > &signatures);
    ...
    static std::map<std::pair<int, int>, int> getMergeWordsIdMap(const std::map< int, std::list< std::unique_ptr<Word> > > &wordsMap);
    static std::map<std::pair<int, int>, int> getMergeSignaturesIdMap(const std::list< std::unique_ptr<Signature> > &signatures);
    static std::list< std::unique_ptr<Word> > mergeWords(std::map< int, std::list< std::unique_ptr<Word> > > &&wordsMap, const std::map<std::pair<int, int>, int> &mergeWordsIdMap, const std::map<std::pair<int, int>, int> &mergeSignaturesIdMap);
